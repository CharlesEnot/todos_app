...
<div class="container mt-5">
    ...
    <form method="POST" class="row g-3 mb-4">
        <div class="col-auto"><input type="text" name="name" class="form-control" placeholder="New category" required></div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <td><a href="?delete=<?php echo $cat['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete?')">Delete</a></td></tr>
            <?php endforeach; ?>
        </tbody>
    </table>
</div>
